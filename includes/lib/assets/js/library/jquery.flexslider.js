...
(function ($) {
					...
					onTouchEnd = function(e) {
						...
						if (slider.animatingTo === slider.currentSlide && !scrolling && !(dx === null)) {
							...
							if (slider.canAdvance(target) && (Number(new Date()) - startT < 550 && Math.abs(updateDx) > 50 || Math.abs(updateDx) > cwidth/2)) {
								...
								// ThemeFusion Edit, fix for #7328.
								if ( !fade && slider.canAdvance(target) ) { slider.flexAnimate(slider.currentSlide, slider.vars.pauseOnAction, true); }
							}
						}
						el.removeEventListener('touchend', onTouchEnd, false);

						// ThemeFusion Edit, fix for #1726 & #7122.
						if ( slider.vars.slideshow ) {
							slider.play();
						}
	...
	$.flexslider.defaults = {
		...
		prevText: "&#xf104;",		   //String: Set the text for the "previous" directionNav item, ThemeFusion edit
		nextText: "&#xf105;",		   //String: Set the text for the "next" directionNav item, ThemeFusion edit
	...
	$.fn.flexslider = function(options) {
		...
		if (typeof options === "object") {
			...
			switch (options) {
				...
				case "destroy": $slider.destroy(); break; // ThemeFusion edit
